...
CREATE TABLE IF NOT EXISTS "hopr_balance" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "hopr_safe_contract" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "address" blob (20) NOT NULL UNIQUE
);

CREATE TABLE IF NOT EXISTS "hopr_safe_contract_state" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "hopr_node_safe_registration" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "hopr_safe_redeemed_stats" (
    "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
    "safe_address" blob (20) NOT NULL,
