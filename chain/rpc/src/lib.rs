...
impl TryFrom<AlloyLog> for Log {
    type Error = LogConversionError;

    fn try_from(value: AlloyLog) -> std::result::Result<Self, Self::Error> {
        Ok(Self {
...
#[cfg(test)]
mod tests {
    use hopr_bindings::exports::alloy::primitives::{Log as AlloyPrimitiveLog, LogData};
