//! Channel state decoding utilities.
//!
//! Provides types and functions for decoding packed channel state from
//! bytes32 values emitted by HOPR smart contract events.
...
pub fn decode_channel(channel: B256) -> DecodedChannel {
...
mod tests {
    ...
    fn test_decode_channel_open_status() {
        ...
        let decoded = decode_channel(packed);
