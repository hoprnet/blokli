...
mod public_entities {
    ...
    pub use super::codegen::{account, channel, hopr_balance, native_balance};

    // Generate the register function for these entities only
    seaography::register_entity_modules!([account, channel, hopr_balance, native_balance,]);
}
...
///
/// Internal entities (announcement, hopr_safe_contract, log, log_status, corrupted_channel,
