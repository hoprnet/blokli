//! SeaORM entity for the `safe_owner_current` database view
...
#[sea_orm(table_name = "safe_owner_current")]
pub struct Model {
    #[sea_orm(primary_key, auto_increment = false)]
    pub safe_contract_id: i64,
    #[sea_orm(primary_key, auto_increment = false, column_type = "Binary(20)")]
