...
non-zero Aggregator address. The address can be supplied independently through
`curvy_aggregator` or together with the Vault and PortalFactory addresses in the
`[contracts]` override.
