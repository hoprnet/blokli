...
pub enum Network {
    ...
    AnvilLocalhost,
    /// jura-dev testnet (development/testing network)
    #[default]
    #[serde(alias = "jura-dev")]
    JuraDev,
    /// jura-prod testnet (staging network)
    #[serde(alias = "jura-prod")]
    JuraProd,
    /// piz-palu-dev testnet (development/testing network)
...
mod tests {
    ...
    fn test_network_resolve() {
        ...
        assert!(
            jura_dev.is_some(),
            "Jura-dev network should be defined in hopr-bindings"
        );
        ...
        assert!(
            jura_prod.is_some(),
            "Jura-prod network should be defined in hopr-bindings"
        );
    }
}
