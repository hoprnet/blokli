...
| Alert                                                                    | Severity | Responsible     | Description                                                                                      |
| ------------------------------------------------------------------------ | -------- | --------------- | ------------------------------------------------------------------------------------------------ |
| [Transaction Failed](blokli-transaction-failed.md)                       | Warning  | DevOps Engineer | Transaction failures (reverted/timeout/submission_failed) spiked above their recent baseline     |
